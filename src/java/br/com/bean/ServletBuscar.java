    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Usuario u = new Usuario();//criando o objeto do tipo entidade para setar o valor de retorno
                ManterUsuario mu = new ManterUsuario();//criando o objeto do tipo dao para executar o método pesquisar
                u = mu.pesquisar(id);
